...
CREATE TABLE `chat_history`  (
  ...
  `timestamp` datetime(0) DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `dish_ingredients`  (
  ...
  `portion` int(0) NOT NULL,
  PRIMARY KEY (`dish_id`, `material_id`) USING BTREE,
  INDEX `fk_material`(`material_id`) USING BTREE,
...
CREATE TABLE `dishes`  (
  `dish_id` int(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `price` decimal(10, 2) NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `allergens` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `total_fiber` decimal(10, 2) DEFAULT NULL,
  `total_sugar` decimal(10, 2) DEFAULT NULL,
  `iron` decimal(10, 2) DEFAULT NULL COMMENT 'mg',
  `calcium` decimal(10, 2) DEFAULT NULL COMMENT 'mg',
  `vitamin_c` decimal(10, 2) DEFAULT NULL COMMENT 'mg',
...
CREATE TABLE `main_userinputdishtable`  (
  ...
  `sugar_added` float DEFAULT NULL,
...
CREATE TABLE `order_evaluation`  (
  ...
  `order_id` int(0) NOT NULL,
  `rating` tinyint(0) NOT NULL,
  `content` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `evaluation_time` datetime(0) DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `order_items`  (
  `order_item_id` int(0) NOT NULL AUTO_INCREMENT,
  `order_id` int(0) NOT NULL,
  `dish_id` int(0) NOT NULL,
  ...
  INDEX `fk_dish_order`(`dish_id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 99916 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `orders`  (
  ...
  `user_id` int(0) NOT NULL,
  `order_time` datetime(0) DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE = InnoDB AUTO_INCREMENT = 50098 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `users`  (
  ...
  `gender` enum('男','女','其他') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `allergens` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `chronic_diseases` set('高血压','高血糖','高血脂') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
